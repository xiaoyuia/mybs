<template>
  <div>
    ...
    <div style="margin: 10px  0 ">
      <el-button type="primary" @click="handleAdd" v-if="typeNum == 1">新增<i class="el-icon-circle-plus-outline"></i></el-button>
      ...
      <el-popconfirm
          ...
          @confirm="delBatch"
      >
        <el-button type="danger" slot="reference" v-if="typeNum == 1">批量删除<i class="el-icon-remove-outline"></i></el-button>
      </el-popconfirm>
      ...
      教师姓名：<el-input style="width:200px" suffix-icon="el-icon-search" placeholder="请输入..." v-model="name"></el-input>
    ...
    <el-table :data="tableData" border stripe @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="40" v-if="typeNum == 1"></el-table-column>
      <el-table-column prop="tno" label="工号" width="140">
      </el-table-column>
      <el-table-column prop="clazzName" label="任课班级" width="120">
      </el-table-column>
      ...
      <el-table-column label="操作" v-if="typeNum == 1">
    ...
    <!--新增对话框 -->
    <el-dialog title="添加教师信息" :visible.sync="dialogFormVisible" width="25%">
